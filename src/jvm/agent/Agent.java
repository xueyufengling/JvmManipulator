...
public class Agent {
	...
	static {
		VmEntryObject.setSystemProperty("jdk.attach.allowAttachSelf", "true");// 并非实际允许调用，只是记录在系统中
		Class<?> cls = null;
		try {
	...
	public static void attach(String agent_path, String args) {
		attach(VmEntryObject.getProcessId(), agent_path, args);
	}
